            ...
            return (
                <View style={{flex: 1, backgroundColor: '#eaeaea'}}>
                    ...
                    <TouchableHighlight style={styles.addButton}
                                        underlayColor='#ff7043' onPress={() => this.props.navigation.navigate('Quote')}>
    ...
    showOptions(quote) {
        ActionSheetIOS.showActionSheetWithOptions({
            ...
            (buttonIndex) => {
                ...
                if (buttonIndex === 0) this.props.navigation.navigate('Quote', {quote: quote, edit: true, title:"Edit Quote"})
